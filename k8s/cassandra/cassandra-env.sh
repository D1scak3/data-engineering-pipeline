...
# add jmx prometheus exporter as a javaagent
JVM_OPTS="$JVM_OPTS -javaagent:/opt/cassandra/lib/jmx_prometheus_javaagent-0.18.0.jar=7070:/opt/cassandra/conf/jmx_exporter.yaml" 
